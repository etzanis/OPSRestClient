...
package targetPharmacologyList.model;
...
public class HasTarget {
    ...
    @JsonProperty("targetOrganismName")
    private String targetOrganismName;
     ...
     * 
     * @return
     *     The targetOrganismName
     */
    @JsonProperty("targetOrganismName")
    public String getTargetOrganismName() {
        return targetOrganismName;
    }

    /**
     * 
     * @param targetOrganismName
     *     The targetOrganismName
     */
    @JsonProperty("targetOrganismName")
    public void setTargetOrganismName(String targetOrganismName) {
